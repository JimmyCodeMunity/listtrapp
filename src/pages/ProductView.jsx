          ...
          <div className="w-full grid grid-cols-2 sm:py-4 py-4">
            ...
            <div className="w-full h-full p-5 flex flex-col items-start space-y-4">
              ...
              <button
                ...
                className="w-full mt-4 bg-blue-600 hover:bg-blue-700 text-white py-3 px-6 rounded-lg flex items-center justify-center gap-2 transition-colors font-medium"
              >
                <DollarSign size={20} />
                Make an Offer
              </button>
            ...
            <div className="bg-white rounded-xl p-6 max-w-md w-full">
              ...
              <div className="mb-4">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Listed Price: <span className="font-semibold">KSh {product?.price?.toLocaleString()}</span>
                </p>
