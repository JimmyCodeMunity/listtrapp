  ...
  return (
    <footer class="w-full">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="md:grid hidden grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
          <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
            <a href="/" class="flex justify-center lg:justify-start">
              <h1 className="text-2xl font-bold">Listtr</h1>
            </a>
            <p class="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left text-xs">
              Trusted in more than 100 countries & 5 million customers. Have any
              query ?
            </p>
            <a
              href="javascript:;"
              class="py-2.5 px-5 h-9 block w-fit bg-orange-500 rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-orange-600 lg:mx-0"
            >
              Contact us
            </a>
          </div>
          <div class="lg:mx-auto text-left ">
            <h4 class="text-lg text-gray-900 font-medium mb-7">Listtr</h4>
            <ul class="text-xs  transition-all duration-500">
              <li class="mb-6">
                <a
                  href="javascript:;"
          ...
          <div class="lg:mx-auto text-left ">
            ...
            <p class="text-xs text-gray-500 leading-6 mb-7">
              Subscribe to get the latest news from us
            </p>
            <a
              href="javascript:;"
              class="flex items-center justify-center gap-2 border border-orange-500 rounded-full py-3 px-6 w-fit lg:mx-0  text-xs text-orange-500 font-semibold transition-all duration-500 hover:bg-orange-50"
            >
              Subscribe
            </a>
          </div>
        </div>
        <div class="md:py-7 mb-4 border-t border-gray-200">
          <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            <span class="text-sm text-gray-500 ">
              ©<a href="https://Listtr.io/">Listtr</a> 2024, All rights
              reserved.
            </span>
