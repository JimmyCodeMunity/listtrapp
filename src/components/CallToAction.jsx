export default function CallToAction() {
  return (
    <>
      ...
      <div className="max-w-5xl py-16 md:w-full mx-2 md:mx-auto flex flex-col items-center justify-center text-center bg-gradient-to-b from-[#5524B7] to-[#F49B06] rounded-2xl p-10 text-white">
        ...
        <button className="px-8 py-3 text-white bg-black hover:bg-orange-500 transition-all rounded-full uppercase text-sm mt-8">
          Sell On Listr
        </button>
      </div>
    </>
